...
public class Items extends BaseEntity{
    ...
    public Items(String jsonValues, String jsonSchema) {
        this();
        try{
            ...
            if(values.has("articulo")){
                this.articulo=values.getString("articulo");
            }

            if(articulo.equals("item_176")) {
                db = schema.getJSONObject("inEsp");
            }else{
                db = schema.getJSONObject("in");
            }
...
//            this.guia=guia;
    ...
    public Items(String[] columnNames, String[] resultColumns) {
        this();
